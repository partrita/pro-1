...
<answer> ANSWER HERE </answer>. Follow the formatting instructions exactly as specified. [USER]: {user_message} [ASSISTANT]:"""
        ...
        try:
            ...
            # Extract just the assistant's part of the response if needed
...
if __name__ == "__main__":
    ...
    DATASET_PATH = "path/to/your/dataset.json"  # Update with your actual dataset path
    OUTPUT_PATH = "results/grpo_func_eval_results.json"
